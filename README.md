...
Historische lokale Kontakt- und Arbeitsdateien sind aus dem aktuellen Hauptstand entfernt. Die zusaetzliche Bereinigung oeffentlicher Git-Objekte, Branches, Tags, Releases, Actions-Artefakte und Caches ist freigegeben und wird nach dem sauberen Pages-Deployment gemaess [Datenschutz-Runbook](dokumentation/betrieb-und-deployment/GIT_HISTORY_DATENSCHUTZBEREINIGUNG.md) kontrolliert abgeschlossen. Erst die dokumentierte Remote- und Cache-Abnahme erlaubt die Aussage „vollstaendig aus dem oeffentlichen Repository entfernt“.
