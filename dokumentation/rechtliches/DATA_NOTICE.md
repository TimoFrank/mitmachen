...
This repository does not include production data.

The demo and sample data included in this repository is fictional and is
...
rules, source terms, database rights, contracts, and permissions.

Do not commit personal data, confidential data, production exports,
administrative keys, service-role keys, or other operational secrets to
this repository.
