...
- Nie "sichtbar", "verfügbar", "live" oder "öffentlich geprüft" für geschützte Daten schreiben, wenn nur das statische Pages-Artefakt oder eine GitHub-Pages-URL geprüft wurde. Pages belegt nur die synthetischen CRM-/Fachdaten und den kuratierten öffentlichen Bundestags-Snapshot; die Realanwendung benötigt eine getrennte Target-, API- und Identity-Abnahme.
