...
| G-03 Zugriff | Genau eine regulaere menschliche IAP-Identitaet mit MFA ist zulaessig. Vor Apply werden exakte Backend-IAP-Gruppenmitgliedschaft, projektweite Break-glass-Bindung und geerbte IAM-Principals geprueft. Jeder weitere Mensch oder unbekannte Principal bedeutet No-Go. Dieselbe Person kontrolliert Regel- und Break-glass-Zugang; ein unabhaengiger Wiederherstellungszugang fehlt als akzeptiertes Single-Person-Risiko. | `TECHNISCH VERIFIZIERT` erst nach IAP-/IAM-Nachweis vor Apply und erneut vor Dienstoeffnung |
