export function safeSessionReturnPath(candidate, origin) {
  ...
  try {
    ...
    const applicationPath = /^\/(?:start|versorgung|stakeholder|hospitationen|hospitationskompass|profil|personen|organisationen|formate|teams|onboarding)(?:\/|$)/u.test(target.pathname);
