...
function transformDemoData(data) {
  ...
  const contacts = data.contacts.map((source) => {
    ...
    phone: null,
    linkedin: null,
    relationship_basis: source.relationshipBasis || "review_required",
    ...
    ehc_consent_text_version: source.ehcConsentTextVersion || null,
    ehc_consent_recorded_by: mappedProfileId(source.ehcConsentRecordedBy, profileIdMap),
    ehc_consent_note: source.ehcConsentNote || null,
