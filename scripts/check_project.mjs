...
const syntaxFiles = [
  ...
  "api/identity-bootstrap-claim.mjs",
  "api/identity-provision.mjs",
  "api/object-storage.mjs",
  "api/server.mjs",
  "api/verify-object-storage.mjs",
  ...
  "scripts/test_hospitation_codebook.mjs",
  "scripts/test_hospitation_evidence_contract.mjs",
  ...
  "scripts/test_pre_gematik_password_invitation.mjs",
  ...
  "scripts/test_object_storage.mjs",
  "scripts/test_profile_avatar_reference_contract.mjs",
  "scripts/test_request_log_privacy.mjs",
  "scripts/test_single_server_contract.mjs",
  "scripts/test_single_server_backup_recovery.mjs",
  "scripts/test_single_server_identity_provision.mjs",
  "scripts/test_single_server_identity_preview_output.mjs",
  "deploy/single-server/hash-persistence-contract.mjs",
  "deploy/single-server/validate-cutover-open-gates.mjs",
  "deploy/single-server/validate-code-reopen-gates.mjs",
  "deploy/single-server/test_validate_cutover_open_gates.mjs",
  "deploy/single-server/test_validate_code_reopen_gates.mjs",
  "deploy/single-server/migration/test_export_database.mjs",
  "deploy/single-server/migration/gke-writer-freeze.mjs",
  "deploy/single-server/migration/test_gke_writer_freeze.mjs",
  ...
  "scripts/test_pre_gematik_online_onboarding_orchestrator.mjs",
...
const auditCommands = [
  ...
  ["node", ["scripts/test_profile_avatar_reference_contract.mjs"]],
  ["node", ["scripts/test_object_storage.mjs"]],
  ["node", ["scripts/test_single_server_contract.mjs"]],
  ["node", ["deploy/single-server/test_validate_cutover_open_gates.mjs"]],
  ["node", ["deploy/single-server/test_validate_code_reopen_gates.mjs"]],
  ...
  ["node", ["scripts/test_hospitation_codebook.mjs"]],
  ["node", ["scripts/test_hospitation_evidence_contract.mjs"]],
  ...
  ["node", ["scripts/test_pre_gematik_online_onboarding_orchestrator.mjs"]],
  ["node", ["scripts/test_pre_gematik_password_invitation.mjs"]],
  ["node", ["scripts/test_pre_gematik_guest_welcome_email.mjs"]],
  ["node", ["scripts/test_pre_gematik_guest_welcome_email_send.mjs"]],
